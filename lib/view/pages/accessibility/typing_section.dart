    ...
    return SimpleDialog(
      ...
      children: [
        SliderSettingsRow(
          ...
          min: 100,
          max: 2500,
          value: model.getCursorBlinkTime,
...
class _TypingAssist extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SettingsRow(
      ...
      secondChild: Row(
        children: [
          Text(model.getTypingAssistString),
    ...
    return Padding(
      ...
      child: Column(
        children: [
          SliderSettingsSecondary(
            label: 'Acceptance delay',
            enabled: model.getBounceKeys,
            min: 0,
            max: 900,
            value: model.getBounceKeysDelay,
            onChanged: (value) => model.setBounceKeysDelay(value),
          ),
          CheckboxRow(
            enabled: model.getBounceKeys,
            value: model.getBounceKeysBeepReject,
